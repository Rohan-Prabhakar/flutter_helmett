...
import 'package:flutter_helmett/screenss/login/widgets/headerr.dart';

import '../../constants.dart';
import 'widgets/custom_clippers/index.dart';
import 'widgets/header.dart';
import 'widgets/loginn_form.dart';
        ...
        children: <Widget>[
          ...
          SafeArea(
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  Headerr(animation: _headerTextAnimation),
                  SizedBox(height:  MediaQuery.of(context).size.height/5),
                  LoginnForm(animation: _formElementAnimation),
                ],
              ),
            ),
          ),
